...
if data is not None:
    ...
    with col2:
        ...
        # City
        City = st.selectbox(
            "City", cities, help="Select the city where the car is located."
        )

        # Insurance
        Insurance = st.selectbox(
            "Insurance", insurances, help="Select the insurance status of the car."
        )
        ...
        if st.button("💡 Predict Price", type="primary"):
            ...
            st.write(
                "Based on the details provided, this is the estimated resale price."
            )
